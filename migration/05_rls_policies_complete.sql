...
USING (
  EXISTS (
    SELECT 1 FROM public.officers o
    JOIN public.positions p ON o.position_id = p.id
    WHERE o.user_id = auth.uid()
    AND p.name IN ('Inventory Manager', 'Store Keeper')
  )
)
WITH CHECK (
  EXISTS (
...
-- =============================================
-- SECTION 50: INVENTORY_ITEMS POLICIES (4)
-- =============================================

CREATE POLICY "Admin full access to inventory_items"
...
CREATE POLICY "CEO full access to inventory_items"
ON public.inventory_items
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
CREATE POLICY "Management can manage inventory_items"
ON public.inventory_items
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'management'::public.app_role))
...
CREATE POLICY "Officers can view inventory_items"
ON public.inventory_items
FOR SELECT
TO authenticated
USING (public.has_role(auth.uid(), 'officer'::public.app_role));
...
-- =============================================
-- SECTION 51: INVOICE_LINE_ITEMS POLICIES (3)
-- =============================================
...
CREATE POLICY "CEO full access to invoice_line_items"
ON public.invoice_line_items
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
CREATE POLICY "Management can view invoice_line_items"
ON public.invoice_line_items
FOR SELECT
TO authenticated
USING (public.has_role(auth.uid(), 'management'::public.app_role));
...
CREATE POLICY "Admin full access to invoice_number_sequences"
...
CREATE POLICY "CEO full access to invoice_number_sequences"
ON public.invoice_number_sequences
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
-- =============================================
-- SECTION 53: INVOICES POLICIES (3)
-- =============================================
...
CREATE POLICY "CEO full access to invoices"
ON public.invoices
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
CREATE POLICY "Management can view invoices"
ON public.invoices
FOR SELECT
TO authenticated
USING (public.has_role(auth.uid(), 'management'::public.app_role));
...
-- =============================================
-- SECTION 54: JOB_APPLICATIONS POLICIES (4)
-- =============================================

CREATE POLICY "Anyone can apply to open job_postings"
...
CREATE POLICY "Applicants can view their own job_applications"
ON public.job_applications
FOR SELECT
TO authenticated
USING (
...
CREATE POLICY "CEO can manage job_applications"
ON public.job_applications
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
-- =============================================
-- SECTION 55: JOB_POSTINGS POLICIES (3)
-- =============================================

CREATE POLICY "Anyone can view open job_postings"
ON public.job_postings
FOR SELECT
TO authenticated
USING (status = 'open');

CREATE POLICY "Admin can manage job_postings"
ON public.job_postings
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "CEO can manage job_postings"
ON public.job_postings
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
-- =============================================
-- SECTION 56: LEADERBOARD_CONFIGS POLICIES (2)
-- =============================================

CREATE POLICY "Anyone can view public leaderboard_configs"
ON public.leaderboard_configs
FOR SELECT
TO authenticated
USING (is_public = true);

CREATE POLICY "Admin can manage leaderboard_configs"
ON public.leaderboard_configs
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "Admin full access to leave_applications"
ON public.leave_applications
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "CEO full access to leave_applications"
ON public.leave_applications
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
CREATE POLICY "Admin can manage leave_approval_hierarchy"
ON public.leave_approval_hierarchy
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
-- =============================================
-- SECTION 59: LEAVE_BALANCE_ADJUSTMENTS POLICIES (1)
-- =============================================

CREATE POLICY "CEO can manage leave_balance_adjustments"
...
-- =============================================
-- SECTION 60: LEAVE_BALANCES POLICIES (2)
-- =============================================
...
CREATE POLICY "Admin can manage leave_balances"
ON public.leave_balances
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
-- =============================================
-- SECTION 61: LEAVE_SETTINGS POLICIES (2)
-- =============================================
...
CREATE POLICY "Admin can manage leave_settings"
ON public.leave_settings
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
-- =============================================
-- SECTION 62: NEWSLETTERS POLICIES (2)
-- =============================================
...
CREATE POLICY "Admin full access to officer_attendance"
ON public.officer_attendance
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "Admin full access to officer_class_access_grants"
ON public.officer_class_access_grants
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "Admin full access to officer_documents"
ON public.officer_documents
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "Admin full access to officers"
ON public.officers
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "CEO can view all officers"
ON public.officers
FOR SELECT
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role));
...
CREATE POLICY "Admin full access to overtime_requests"
ON public.overtime_requests
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "CEO full access to overtime_requests"
ON public.overtime_requests
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
CREATE POLICY "CEO full access to payroll_records"
ON public.payroll_records
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
CREATE POLICY "Admin full access to performance_appraisals"
ON public.performance_appraisals
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "CEO full access to performance_appraisals"
ON public.performance_appraisals
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
-- =============================================
-- SECTION 73: PROFILES POLICIES (7)
-- =============================================
...
CREATE POLICY "Admin full access to project_achievements"
...
CREATE POLICY "Admin full access to project_progress_updates"
...
-- =============================================
-- SECTION 77: PROJECTS POLICIES (6)
-- =============================================
...
CREATE POLICY "CEO can view all projects"
ON public.projects
FOR SELECT
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role));
...
CREATE POLICY "Admin can manage purchase_approval_chain"
ON public.purchase_approval_chain
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "CEO can manage purchase_approval_chain"
ON public.purchase_approval_chain
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
-- =============================================
-- SECTION 79: PURCHASE_REQUESTS POLICIES (5)
-- =============================================

CREATE POLICY "Users can view their own purchase_requests"
...
CREATE POLICY "CEO full access to purchase_requests"
ON public.purchase_requests
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
CREATE POLICY "Management can manage purchase_requests"
ON public.purchase_requests
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'management'::public.app_role))
...
-- =============================================
-- SECTION 80: REPORTS POLICIES (3)
-- =============================================

CREATE POLICY "Management can view published reports"
ON public.reports
FOR SELECT
TO authenticated
USING (
...
CREATE POLICY "Admin full access to staff_attendance"
ON public.staff_attendance
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "CEO full access to staff_attendance"
ON public.staff_attendance
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
-- =============================================
-- SECTION 83: STAFF_DOCUMENTS POLICIES (1)
-- =============================================

CREATE POLICY "Authenticated full access to staff_documents"
...
CREATE POLICY "Admin full access to student_badges"
ON public.student_badges
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "Officers can view institution student_badges"
ON public.student_badges
FOR SELECT
TO authenticated
USING (public.has_role(auth.uid(), 'officer'::public.app_role));

CREATE POLICY "System can award student_badges"
ON public.student_badges
FOR INSERT
TO authenticated
WITH CHECK (true);
...
-- =============================================
-- SECTION 85: STUDENT_CERTIFICATES POLICIES (3)
-- =============================================
...
CREATE POLICY "Admin full access to student_certificates"
ON public.student_certificates
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "Officers can manage student_certificates"
ON public.student_certificates
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'officer'::public.app_role))
...
-- =============================================
-- SECTION 86: STUDENT_CONTENT_COMPLETIONS POLICIES (3)
-- =============================================
...
CREATE POLICY "Admin full access to student_content_completions"
ON public.student_content_completions
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "Admin full access to student_feedback"
ON public.student_feedback
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "Officers can respond to student_feedback"
ON public.student_feedback
FOR UPDATE
TO authenticated
USING (public.has_role(auth.uid(), 'officer'::public.app_role))
...
-- =============================================
-- SECTION 88: STUDENT_STREAKS POLICIES (2)
-- =============================================
...
CREATE POLICY "Admin full access to student_streaks"
ON public.student_streaks
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "Students can insert their own student_xp_transactions"
ON public.student_xp_transactions
FOR INSERT
TO authenticated
WITH CHECK (student_id = auth.uid());

CREATE POLICY "Admin full access to student_xp_transactions"
ON public.student_xp_transactions
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
-- =============================================
-- SECTION 90: STUDENTS POLICIES (6)
-- =============================================
...
CREATE POLICY "Officers can view institution students"
ON public.students
FOR SELECT
TO authenticated
USING (
...
CREATE POLICY "CEO can view all students"
ON public.students
FOR SELECT
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role));
...
CREATE POLICY "Anyone can view questions for visible surveys"
...
CREATE POLICY "Admin can manage survey_questions"
ON public.survey_questions
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "CEO can manage survey_questions"
ON public.survey_questions
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
-- =============================================
-- SECTION 92: SURVEY_RESPONSE_ANSWERS POLICIES (3)
-- =============================================

CREATE POLICY "Students can insert their own survey_response_answers"
...
CREATE POLICY "Admin can manage survey_response_answers"
ON public.survey_response_answers
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "CEO can view survey_response_answers"
ON public.survey_response_answers
FOR SELECT
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role));
...
CREATE POLICY "Students can manage their own survey_responses"
...
CREATE POLICY "Admin can manage survey_responses"
ON public.survey_responses
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "Officers can view institution survey_responses"
ON public.survey_responses
FOR SELECT
TO authenticated
USING (public.has_role(auth.uid(), 'officer'::public.app_role));

CREATE POLICY "CEO can view all survey_responses"
ON public.survey_responses
FOR SELECT
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role));
...
-- =============================================
-- SECTION 94: SURVEYS POLICIES (4)
-- =============================================

CREATE POLICY "Students can view targeted surveys"
ON public.surveys
FOR SELECT
TO authenticated
USING (
...
-- =============================================
-- SECTION 95: SYSTEM_CONFIGURATIONS POLICIES (3)
-- =============================================

CREATE POLICY "Authenticated can read platform system_configurations"
ON public.system_configurations
FOR SELECT
TO authenticated
USING (config_key LIKE 'platform%');

CREATE POLICY "Admin can manage system_configurations"
ON public.system_configurations
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "CEO can manage system_configurations"
ON public.system_configurations
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
-- =============================================
-- SECTION 96: SYSTEM_LOGS POLICIES (3)
-- =============================================
...
CREATE POLICY "CEO can view system_logs"
ON public.system_logs
FOR SELECT
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role));
...
CREATE POLICY "Admin full access to task_activity_log"
ON public.task_activity_log
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "System can insert task_activity_log"
ON public.task_activity_log
FOR INSERT
TO authenticated
WITH CHECK (true);
...
CREATE POLICY "Admin full access to task_attachments"
ON public.task_attachments
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "Officers can comment on their tasks"
...
CREATE POLICY "Admin full access to task_comments"
ON public.task_comments
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "CEO can view all task_comments"
ON public.task_comments
FOR SELECT
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role));
...
CREATE POLICY "Authenticated can view active webinars"
ON public.webinars
FOR SELECT
TO authenticated
USING (status = 'active');
...
CREATE POLICY "CEO can manage webinars"
ON public.webinars
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
CREATE POLICY "Authenticated can view active xp_rules"
ON public.xp_rules
FOR SELECT
TO authenticated
USING (is_active = true);

CREATE POLICY "Admin can manage xp_rules"
ON public.xp_rules
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'admin'::public.app_role))
...
CREATE POLICY "CEO can manage xp_rules"
ON public.xp_rules
FOR ALL
TO authenticated
USING (public.has_role(auth.uid(), 'ceo'::public.app_role))
...
-- =============================================
-- END OF COMPLETE RLS POLICIES MIGRATION
-- Total: 461 policies across 103 tables
-- =============================================
