...
export const mockPayrollData: PayrollRecord[] = [
  ...
  },
  {
    ...
    salary_components: [
      ...
      { component_type: 'da', amount: 4960, is_taxable: true, calculation_type: 'fixed' },
      { component_type: 'hra', amount: 9920, is_taxable: true, calculation_type: 'fixed' },
      { component_type: 'cca', amount: 2480, is_taxable: false, calculation_type: 'fixed' },
      { component_type: 'special_allowance', amount: 19840, is_taxable: true, calculation_type: 'fixed' },
    ],
  ...
  },
  {
    ...
    salary_components: [
      ...
      { component_type: 'da', amount: 4400, is_taxable: true, calculation_type: 'fixed' },
      { component_type: 'hra', amount: 8800, is_taxable: true, calculation_type: 'fixed' },
      { component_type: 'cca', amount: 2200, is_taxable: false, calculation_type: 'fixed' },
      { component_type: 'special_allowance', amount: 17600, is_taxable: true, calculation_type: 'fixed' },
    ],
  ...
  },
  {
    ...
    salary_components: [
      ...
      { component_type: 'da', amount: 4800, is_taxable: true, calculation_type: 'fixed' },
      { component_type: 'hra', amount: 9600, is_taxable: true, calculation_type: 'fixed' },
      { component_type: 'cca', amount: 2400, is_taxable: false, calculation_type: 'fixed' },
      { component_type: 'special_allowance', amount: 19200, is_taxable: true, calculation_type: 'fixed' },
    ],
  ...
  },
  {
    ...
    salary_components: [
      ...
      { component_type: 'da', amount: 4640, is_taxable: true, calculation_type: 'fixed' },
      { component_type: 'hra', amount: 9280, is_taxable: true, calculation_type: 'fixed' },
      { component_type: 'cca', amount: 2320, is_taxable: false, calculation_type: 'fixed' },
      { component_type: 'special_allowance', amount: 18560, is_taxable: true, calculation_type: 'fixed' },
    ],
