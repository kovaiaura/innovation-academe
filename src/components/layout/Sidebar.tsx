...
const menuItems: MenuItem[] = [
  ...
  { label: 'Awards & Achievements', icon: <Trophy className="h-5 w-5" />, path: '/awards', roles: ['super_admin'] },
  ...
  { label: 'External Events', icon: <Trophy className="h-5 w-5" />, path: '/event-management', roles: ['system_admin'], feature: 'event_management' },
  // Officers Management
  ...
  { label: 'Awards & Achievements', icon: <Trophy className="h-5 w-5" />, path: '/awards', roles: ['system_admin'], feature: 'awards_achievements' as any },
  // Inventory & Purchase
  ...
  { label: 'MetaINNOVA™ Events', icon: <Video className="h-5 w-5" />, path: '/webinars', roles: ['system_admin'], feature: 'webinar_management' },
  // Reports & Invoice
  ...
  { label: 'External Events', icon: <Trophy className="h-5 w-5" />, path: '/events', roles: ['officer'] },
  { label: 'Ask Metova', icon: <MessageSquare className="h-5 w-5" />, path: '/ask-metova', roles: ['officer'] },
  { label: 'MetaINNOVA™ Events', icon: <Video className="h-5 w-5" />, path: '/webinars', roles: ['officer'] },
  ...
  { label: 'Course Outcomes', icon: <PieChart className="h-5 w-5" />, path: '/course-outcomes', roles: ['student'] },
  
  { label: 'My Projects', icon: <Target className="h-5 w-5" />, path: '/projects', roles: ['student'] },
  { label: 'Awards & Achievements', icon: <Trophy className="h-5 w-5" />, path: '/awards', roles: ['student'] },
  { label: 'External Events', icon: <Trophy className="h-5 w-5" />, path: '/events', roles: ['student'] },
  ...
  { label: 'MetaINNOVA™ Events', icon: <Video className="h-5 w-5" />, path: '/webinars', roles: ['student'] },
  ...
  { label: 'Course Outcomes', icon: <PieChart className="h-5 w-5" />, path: '/course-outcomes', roles: ['management'] },
  ...
  { label: 'Projects', icon: <Target className="h-5 w-5" />, path: '/projects-certificates', roles: ['management'] },
  { label: 'Awards & Achievements', icon: <Trophy className="h-5 w-5" />, path: '/awards', roles: ['management'] },
  { label: 'SDG Dashboard', icon: <Target className="h-5 w-5" />, path: '/sdg-dashboard', roles: ['management'] },
  { label: 'External Events', icon: <Trophy className="h-5 w-5" />, path: '/events', roles: ['management'] },
  { label: 'Reports', icon: <FileText className="h-5 w-5" />, path: '/reports', roles: ['management'] },
  { label: 'MetaINNOVA™ Events', icon: <Video className="h-5 w-5" />, path: '/webinars', roles: ['management'] },
