...
export function CreditNotePDF({
  ...
  return (
    <Document
      title={`Credit Note ${note.note_number}`}
      author={companyName}
      subject={`Credit Note for ${note.customer_name}`}
    >
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.companySection}>
          ...
          <View style={styles.invoiceDetailsBox}>
            <View style={styles.invoiceDetailRow}>
              <Text style={styles.invoiceDetailLabel}>Credit Note No:</Text>
        ...
        <View style={[styles.partyBox, { marginBottom: 20 }]}>
          <Text style={styles.partyLabel}>Credit Note Issued To</Text>
        ...
        {/* Reason */}
        <View style={{ marginBottom: 15, padding: 10, backgroundColor: '#f0f4f8', borderRadius: 4 }}>
          <Text style={{ fontSize: 8, color: '#666666' }}>Reason for Credit Note:</Text>
          <Text style={{ fontSize: 10, fontWeight: 'bold', marginTop: 4 }}>{note.reason}</Text>
        </View>
        ...
        <View style={styles.totalsSection}>
          <View style={styles.totalsBox}>
            ...
            <View style={styles.totalRowLast}>
              <Text style={styles.totalLabelBold}>Total Credit Amount</Text>
