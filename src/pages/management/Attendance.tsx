...
const Attendance = () => {
  ...
  const getStatusColor = (date: Date) => {
    ...
    if (!attendance) return 'bg-muted text-muted-foreground'; // Weekend/No data
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">View officer attendance records in calendar format</p>
        </div>
