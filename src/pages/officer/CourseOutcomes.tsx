    ...
    <Layout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Analyze student performance across courses, modules, and sessions</p>
        </div>
...
export default OfficerCourseOutcomes;
