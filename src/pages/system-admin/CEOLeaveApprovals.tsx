...
export default function CEOLeaveApprovals() {
  ...
  const loadApplications = () => {
    const apps = getLeaveApplicationsByStage('ceo_pending');
  ...
  const handleApprove = () => {
    ...
    try {
      approveLeaveApplicationCEO(selectedApplication.id, user.name, comments || undefined);
      ...
      <div className="p-6 space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Approve leave applications for Meta Staff (MD, AGM, GM, Manager, Admin Staff)
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Meta Staff leave applications awaiting your approval
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Dialog open={isApproveDialogOpen} onOpenChange={setIsApproveDialogOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Grant approval for this meta staff leave application.
              </DialogDescription>
            </DialogHeader>
            {selectedApplication && (
              <div className="space-y-4">
